...
export function ResultsWorkspace({ crawl, crawls, live, tab, setTab, issueFilter, setIssueFilter, onOpenDetail, onFilterByIssue, onOpenTool, onResume, onRerun, crawlBusyMsg }) {
