...
func (r *Request) PostRaw(URL string, requestData []byte) error {
	return r.collector.FetchURL(r.AbsoluteURL(URL), "POST", r.Depth+1, bytes.NewReader(requestData), r.Ctx, nil)
}
...
func (r *Request) Retry() error {
	...
	return r.collector.FetchURL(r.URL.String(), r.Method, r.Depth, r.Body, r.Ctx, hdr)
}
