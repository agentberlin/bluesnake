...
func (r *roundRobinSwitcher) GetProxy(pr *http.Request) (*url.URL, error) {
	...
	ctx := context.WithValue(pr.Context(), bluesnake.ProxyURLKey, u.String())
...
// "http" is assumed.
func RoundRobinProxySwitcher(ProxyURLs ...string) (bluesnake.ProxyFunc, error) {
	if len(ProxyURLs) < 1 {
		return nil, bluesnake.ErrEmptyProxyURL
	}
