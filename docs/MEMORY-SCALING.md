...
forbids). Exception: `Resume.Admitted` (bucket-counter rehydration) is still
materialised when a per-bucket cap is configured — see "Honest residuals".
