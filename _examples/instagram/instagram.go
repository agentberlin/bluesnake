...
func main() {
	...
	c := bluesnake.NewCollector(
		//bluesnake.CacheDir("./_instagram_cache/"),
		bluesnake.UserAgent("Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36"),
	)
	...
	c.OnHTML("html", func(e *bluesnake.HTMLElement) {
		d := c.Clone()
		d.OnResponse(func(r *bluesnake.Response) {
	...
	c.OnError(func(r *bluesnake.Response, e error) {
