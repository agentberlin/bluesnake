...
func main() {
	...
	c := bluesnake.NewCollector(
		...
		bluesnake.AllowedDomains("coursera.org", "www.coursera.org"),

		// Cache responses to prevent multiple download of pages
		// even if the collector is restarted
		bluesnake.CacheDir("./coursera_cache"),
		// Cached responses older than the specified duration will be refreshed
		bluesnake.CacheExpiration(24*time.Hour),
	)
	...
	c.OnHTML(`a.collection-product-card`, func(e *bluesnake.HTMLElement) {
	...
	detailCollector.OnHTML(`div[id=rendered-content]`, func(e *bluesnake.HTMLElement) {
		...
		e.ForEach(".AboutCourse .ProductGlance > div", func(_ int, el *bluesnake.HTMLElement) {
